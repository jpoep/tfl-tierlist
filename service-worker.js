const c = [
  ...
  "/_app/immutable/start-1a8fd6c8.js",
  ...
  "/_app/immutable/pages/index.svelte-75530798.js",
  ...
  "/sounds/till.mp3",
  "/till.png"
], p = "1658835818687", e = self, n = `cache${p}`, i = c.concat(m.filter((s) => !s.endsWith(".nojekyll"))), r = new Set(i);
