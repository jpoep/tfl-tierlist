const c = [
  ...
  "/_app/immutable/start-ef8b6a10.js",
  ...
  "/_app/immutable/pages/index.svelte-7be88b1b.js",
  ...
  "/sounds/till.mp3",
  "/till.png"
], p = "1673903569839", e = self, n = `cache${p}`, i = c.concat(m.filter((s) => !s.endsWith(".nojekyll"))), r = new Set(i);
