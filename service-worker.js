const m = [
  ...
  "/_app/immutable/start-01facd48.js",
  ...
  "/_app/immutable/pages/index.svelte-583b0454.js",
  ...
  "/sounds/till.mp3",
  "/till.png"
], p = "1695420547806", o = self, n = `cache${p}`, i = m.concat(c.filter((s) => !s.endsWith(".nojekyll"))), r = new Set(i);
