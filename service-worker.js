const c = [
  ...
  "/_app/immutable/start-bd0c9983.js",
  ...
  "/_app/immutable/pages/index.svelte-f9a6fa37.js",
  ...
  "/sounds/till.mp3",
  "/till.png"
], p = "1673904849299", e = self, n = `cache${p}`, i = c.concat(m.filter((s) => !s.endsWith(".nojekyll"))), r = new Set(i);
