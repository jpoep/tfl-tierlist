const c = [
  ...
  "/_app/immutable/start-575d609a.js",
  ...
  "/_app/immutable/pages/index.svelte-4f2a5e4b.js",
  ...
  "/sounds/till.mp3",
  "/till.png"
], p = "1674163775076", e = self, n = `cache${p}`, i = c.concat(m.filter((s) => !s.endsWith(".nojekyll"))), r = new Set(i);
