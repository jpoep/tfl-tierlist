const m = [
  ...
  "/_app/immutable/start-b07df024.js",
  ...
  "/_app/immutable/pages/index.svelte-0fe57634.js",
  ...
  "/sounds/till.mp3",
  "/till.png"
], p = "1694948850676", o = self, n = `cache${p}`, i = m.concat(c.filter((s) => !s.endsWith(".nojekyll"))), r = new Set(i);
