const m = [
  ...
  "/_app/immutable/start-1d8d1986.js",
  ...
  "/_app/immutable/pages/index.svelte-37396a58.js",
  ...
  "/sounds/till.mp3",
  "/till.png"
], p = "1695419062838", o = self, n = `cache${p}`, i = m.concat(c.filter((s) => !s.endsWith(".nojekyll"))), r = new Set(i);
