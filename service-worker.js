const m = [
  ...
  "/_app/immutable/start-f21c8950.js",
  ...
  "/_app/immutable/pages/index.svelte-b4e4247c.js",
  ...
  "/sounds/till.mp3",
  "/till.png"
], p = "1694884498159", o = self, n = `cache${p}`, i = m.concat(c.filter((s) => !s.endsWith(".nojekyll"))), r = new Set(i);
