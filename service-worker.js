const c = [
  ...
  "/_app/immutable/start-6e3fa261.js",
  ...
  "/_app/immutable/pages/index.svelte-06061714.js",
  ...
  "/sounds/till.mp3",
  "/till.png"
], p = "1669055115562", e = self, n = `cache${p}`, i = c.concat(m.filter((s) => !s.endsWith(".nojekyll"))), r = new Set(i);
