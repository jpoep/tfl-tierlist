const m = [
  ...
  "/_app/immutable/start-3bcc72af.js",
  ...
  "/_app/immutable/pages/index.svelte-030fb789.js",
  ...
  "/sounds/till.mp3",
  "/till.png"
], p = "1709500213062", o = self, n = `cache${p}`, i = m.concat(c.filter((s) => !s.endsWith(".nojekyll"))), r = new Set(i);
