const m = [
  ...
  "/_app/immutable/start-28788cbc.js",
  ...
  "/_app/immutable/pages/index.svelte-49fc5d1f.js",
  ...
  "/sounds/till.mp3",
  "/till.png"
], p = "1711447298243", o = self, n = `cache${p}`, i = m.concat(c.filter((s) => !s.endsWith(".nojekyll"))), r = new Set(i);
